...
src_prepare() {
	...
	einfo "Apply Patches ${patchdir}"
	eapply "${patchdir}/"
	einfo "Apply patches finished"
	...
	# We need to change "buffio.h" to "tidybuffio.h" in ext/tidy/tidy.c
	# in order to support the newer tidy-html5 library (as opposed to
	# htmltidy). This tip is provided in tidy-html5's README at,
	#
	#   https://github.com/htacg/tidy-html5/tree/master/README
	#
	sed -i 's/#include "buffio.h"/#include "tidybuffio.h"/' ext/tidy/tidy.c \
		|| die "failed to patch ext/tidy/tidy.c for the tidy-html5 library"
